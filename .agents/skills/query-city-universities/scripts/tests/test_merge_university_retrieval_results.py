...
from merge_university_retrieval_results import merge_school_results
...
class MergeUniversityRetrievalResultsTest(unittest.TestCase):
    def test_merge_orders_results_by_base_information(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            payload = merge_school_results(directory, build_base_payload())
    ...
    def test_merge_rejects_missing_school_result(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with self.assertRaisesRegex(ValueError, '缺少学校处理结果'):
                merge_school_results(directory, build_base_payload())
