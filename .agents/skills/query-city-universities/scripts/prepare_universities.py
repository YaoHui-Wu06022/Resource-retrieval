...
def build_output_directory(city, run_date):
    """生成项目根目录下的高校任务输出路径。"""
    return PROJECT_ROOT / 'output' / city / run_date / 'Higher_Education'
...
def main():
    ...
    output_dir = build_output_directory(payload['run']['city'], run_date)
